...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from user where nama='$uname' && password='$Password' ");
...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">Update GIS</h3>
...
<form name="login" method="post">
                        ...
                        <input type="submit" name="login" class="btn btn-primary btn-user btn-block" value="login">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                    <?php /*?>    <a class="small" href="password-recovery.php" style="font-weight:bold">Forgot Password?</a> <?php */?>   
